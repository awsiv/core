...
$test_path = "/tmp";
$filename = 'repaired-summary-' . time();
$export_info = array('path'=>$test_path,'filename'=>$filename,'request_id'=>'asdf', 'csv' => true, 'pdf' => false);

$res = cfpr_summarize_repaired($userName, $hostKey,$promise_context, NULL, $causeRx, $from, $to, $classIncludes, $classExcludes, NULL, false, 0, 0, $export_info);
