...
$res = cfpr_hosts_with_notkept($userName, $hostKey, $promise_context, $name, $causeRx, intval($from), intval($to), $classIncludes, $classExcludes, $rows, $page_number, $export_info);
fwrite(STDERR, $res);
