...
$lang['tooltip_user_dir']="The directory used by the server to store users information  e.g cn=users or ou=people if not under rootdn sepcify the dn as well eg cn=users,ou=administartion";
