...
$lang['tooltip_user_dir']="The directory used by the server to store users information  e.g cn=users or ou=people, If this directory is unnder sub directory specify its name as well eg cn=users,ou=sales";
