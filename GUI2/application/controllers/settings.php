...
class Settings extends Cf_Controller {
    ...
    function manage($op=false, $id=false) {
        ...
        $this->form_validation->set_rules('host', 'LDAP host', 'xss_clean|trim' . $required_if_ldap . $required_if_ad);
        ...
        $this->form_validation->set_rules('users_directory', 'User directory', 'xss_clean|trim' . $required_if_ldap);
