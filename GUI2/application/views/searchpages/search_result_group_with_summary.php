<?php if (isset($show_host_summary) && ($show_host_summary == true)){ ?>
            <div id="hostsInfoContainer" class="hostsInfoContainer innerdiv grid_12" style="">
                ...
                <div id="hostsComplianceContainer" class="hostsComplianceContainer grid_7">
                    <div class="hostsCompliance">
                        <p class="title">Red, Yellow and Green compliance in regard to specified bundle(s).</p>
                ...
                <div class="hostsConnectivityContainer grid_5">
                    <div id="hostsConnectivity" class="hostsConnectivity">
                        <p class="title">Blue and Black host  in regard to specified bundle(s).</p>
                        <div class="colourEntry">
                            <a href="<?php echo site_url("/search/index/" . $detail_result_url . "/hosts_only/true/clevel/black/"); ?>" title="" class="blackhost showqtip hoststatuslist"><?php echo $c_data['black_hosts']; ?> <?php echo $this->lang->line('not_compliant'); ?></a>
                            <a href="<?php echo site_url("/search/index/" . $detail_result_url. "/hosts_only/true/clevel/blue/"); ?>" title=""  class="bluehost showqtip hoststatuslist "><?php echo $c_data['blue_hosts'] ?> <?php echo $this->lang->line('now_compliant'); ?> </a>
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
        ...
        <div class="tables hostlist">
            <p class="title">Hosts in regards to specific bundle <?php if ($clevel) { ?> (compliance level: <?php echo $clevel ?>) <?php } ?></p>
        <?php
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo anchor('welcome/host/' . $rows['hostkey'], $rows['hostname'], 'class=""'); ?></td>
                    <td class="actioncol"><?php echo anchor('search/index/' . $detail_result_url . "/host/".$rows['hostkey'], " ", array('title' => 'show bundle report', 'class' => 'vitalsbtn showqtip')).anchor('search/index/report/promises-not-kept-summary/host/' . $rows['hostkey'], ' ', array('title' => 'promises not kept', 'class' => 'promisesnotkeptbtn showqtip'))
