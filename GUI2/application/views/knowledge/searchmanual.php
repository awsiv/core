    ...
    <div class="outerdiv">
        ...
        <div class="innerdiv" style="min-width: 500px;">
            ...
            <ul style="padding: 5px;" class="knowledgesearch">
                ...
                <li style="padding:5px;"><?php echo sprintf('"<a target="_blank" href="%s">%s</a>" is mentioned in the context of %s',  trim(base_url(),'/').$item['ref'], $item['represents'], $item['context']); ?></li>
                        <?php } ?>
                    <?php } ?>
                </ul>
            <?php } else if ($search) { ?>
