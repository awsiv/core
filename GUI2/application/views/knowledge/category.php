<div>   
    ...
    <ul>
        <li> <?php echo sprintf('<a href="/knowledge/knowledgemap/pid/%s">%s</a>', $topicCategory['topic']['id'], $topicCategory['topic']['name']); ?></li>
        ...
        ?>
            ...
            ?>
                <li> <?php echo sprintf('<a href="/knowledge/knowledgemap/pid/%s">%s</a>', $subtopic['id'], $subtopic['topic']); ?></li>
            <?php } ?>
