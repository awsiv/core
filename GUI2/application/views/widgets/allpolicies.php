<?php
foreach ((array) $viewdata as $index => $data) {  ?><li><span class="type"><?php echo $data[3] ?></span><p><?php echo sprintf('<a href="%s/promise/details/%s" class="promiselnk" title="promise"><span class="promiser">%s</span></a>', site_url(),urlencode($data[0]), $data[4]);
