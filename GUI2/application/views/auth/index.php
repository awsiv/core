        ...
        <div id="darktabs" class="user_roles_management">
            <div class="ui-tabs ui-widget ui-widget-content ui-corner-all" style="margin-left: 0px;">    
                <?php if ($rbac_setting !== true && $is_admin == true) { ?>
                    <div class="rback_off_warning">RBAC is currently <b>globally off</b>, remember to turn it <b>on</b> in <a href="<?php echo site_url('settings/manage')?>">Mission Portal settings</a> to enforce it.</div>
                <?php } ?>
