...
//$config['hosts'] = array('ubuntu1.test.cfengine.com');
$config['hosts'] = array('cf022osx.cfengine.com');
//$config['hosts'] = array('windows1.test.cfengine.com');
$config['ports'] = array(389);
$config['basedn'] = 'dc=cf022osx,dc=cfengine,dc=com';
//$config['basedn'] = 'dc=windows1,dc=test,dc=cfengine,dc=com';
//$config['login_attribute'] = 'uid';   //for openLdap
//$config['login_attribute']='samaccountname';
$config['use_ad'] = false;
$config['ad_domain'] = 'windows1.test.cfengine.com';
$config['proxy_user'] = '';
$config['proxy_pass'] = '';
$config['roles'] = array(1 => 'admin',
                                   3 => 'Power User',
                                   5 => 'User');
