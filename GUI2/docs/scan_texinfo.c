...
void AddTopicAssociation(TopicAssociation **list, char *fwd_name, char *bwd_name, char *topic_type, char *associate,
                         int verify);
...
void AddTopicAssociation(TopicAssociation **list, char *fwd_name, char *bwd_name, char *topic_type, char *associates,
                         int verify)
{
