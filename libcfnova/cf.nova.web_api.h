...
JsonElement *Nova2PHP_promiselog_summary(char *hostkey, char *handle, char *causeRx,
                                         PromiseLogState state, time_t from,
                                         time_t to, HostClassFilter *hostClassFilter,
                                         PageInfo *page, PromiseContextMode promise_context);
JsonElement *Nova2PHP_promiselog(char *hostkey, char *handle, char *causeRx,
...
JsonElement *Nova2PHP_vars_report(const char *hostkey, const char *scope,
...
void Nova2PHP_host_compliance_list_all(EnterpriseDB *conn, HostClassFilter *host_class_filter,
                                       ...
                                       PromiseContextMode promise_context);
int Nova2PHP_show_hosts(char *hostNameRegex, char *ipRegex, HostClassFilter *hostClassFilter,
...
int Nova2PHP_list_promise_handles_with_comments(char *bundle, char *btype,
...
int Nova2PHP_add_note(char *noteid, char *keyhash, char *username, time_t datetime,
                      char *note, char *returnval, int bufsize);
int Nova2PHP_get_notes(char *keyhash, char *cid, char *username, char *filter_username,
...
bool Nova2PHP_host_list_by_environment(HostsList **out, const char *environment,
                                       HostClassFilter *hostClassFilter);
