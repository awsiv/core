...
int Nova2PHP_classes_report(char *hostkey,char *name,int regex,char *classreg,char *buffer,int bufsize);
...
int Nova2PHP_compliance_promises(char *hostkey,char *handle,char *status,int regex,char *classreg,char *buffer,int bufsize);
