...
int Nova2PHP_value_report(char *hostkey,char *day,char *month,char *year,char *classreg,PageInfo *page,char *buffer,int bufsize);
...
int Nova2PHP_compliance_promises(char *hostkey,char *handle,char *status,int regex,char *classreg,PageInfo *page,char *buffer,int bufsize);
int Nova2PHP_lastseen_report(char *hostkey,char *lhash,char *lhost,char *laddr,time_t lago,int lregex,char *classreg,PageInfo *page, char *returnval,int bufsize);
