...
typedef enum cfapi_errid
{
    ...
    ERRID_CONSTELLATION_LICENSE = 13,
    ERRID_DATA_UNAVAILABLE = 14,
    ERRID_HOST_NOT_FOUND = 15,
    ERRID_ACCESS_DENIED = 16,
    ERRID_ACCESS_DENIED_EXTERNAL = 17,
    ERRID_MAX
} cfapi_errid;
...
void Nova2PHP_host_compliance_list(EnterpriseDB *conn, char *colour, HostClassFilter *host_class_filter, PageInfo *page, char *buffer, int bufsize);
