...
}  HRESULT dhGetObject(LPCOLESTR szPathName, LPCOLESTR szProgId, IDispatch ** ppDisp) 
{
        ...
        DH_EXIT(dhGetObjectEx
                (szPathName, szProgId, &IID_IDispatch, CLSCTX_LOCAL_SERVER | CLSCTX_INPROC_SERVER, NULL,
...
static HRESULT InternalInvokeV(int invokeType, VARTYPE returnType, VARIANT * pvResult, IDispatch * pDisp,
        ...
        
    {
            ...
            
        {
                ...
                
            {
                ...
                _snwprintf(pException->szDescription, DESCRIPTION_LENGTH,
