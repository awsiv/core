...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!-- <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>application/assets/css/stylemockup.css" /> -->
		<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>application/assets/css/960.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>application/assets/css/style.css" />
		<link type="text/css" rel="stylesheet" href="<?php echo base_url();?>application/assets/css/jquery.spinbox.css" />
        ...
        <script src="<?php echo base_url();?>application/assets/scripts/jquery.spinbox.js" type="text/javascript"></script>
        <script src="<?php echo base_url();?>application/assets/scripts/jquery.combobox.js" type="text/javascript"></script>
	...
	<div id="wrapper">
	 ...
	 <div id="footer">
	 <span>Upgrade to nova version now!</span>
	 </div>
	</div>
	</body>
</html>