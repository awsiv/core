...
if test "x$with_nova" != xno; then
   ...
   if test -d "${srcdir}/nova"; then
     ...
     NOVA_SUBDIR=nova
     NOVA_LIB_SUBDIRS='nova/sqlite3 nova/libcfnova'
     NOVA_BIN_SUBDIRS='nova/libcfagent nova/libcfmonitord nova/libcfserverd nova/libcfreport nova/cf-know nova/cf-hub'
