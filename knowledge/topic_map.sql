...
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('system outputs','system_outputs','monitoring','Messages sent by cfengine to the operators as a matter of policy.')
...
INSERT INTO topics (topic_name,topic_id,topic_type) values ('oracle','oracle','DB')
INSERT INTO topics (topic_name,topic_id,topic_type) values ('postgres','postgres','DB')
INSERT INTO topics (topic_name,topic_id,topic_type) values ('mysql','mysql','DB')
...
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('DB','DB','directory_services','Relational database services')
...
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('boot','boot','system_services','Boot services are a way of booting a computer directly from the network')
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('monitoring','monitoring','system_services','Pseudo-real-time status information about system components')
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('storage','storage','system_services','Remotely accessible disk volumes.')
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('directory services','directory_services','system_services','Directory services are look-up services, typically with identity or host information.')
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('web','web','system_services','The WWW web service')
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('configuration','configuration','system_services','Cfengine desired-state automation and self-repair service')
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('mail','mail','system_services','Electronic mail service, as made famous by the Unix operating system.')
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('system reports','system_reports','cfengine_knowledge_base','Reports generated by cfengine')
...
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('BDMA','BDMA','models_of_system_administration','Build, Deploy, Manage and Audit. A model for the system life-cycle.')
...
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('available patches','available_patches','mission_status','Patches already installed on system')
INSERT INTO topics (topic_name,topic_id,topic_type,topic_comment) values ('installed patches','installed_patches','mission_status','Patches not yet installed, but published by vendor')
...
INSERT INTO topics (topic_name,topic_id,topic_type) values ('operation\\\'s view','operation_s_view','views')
INSERT INTO topics (topic_name,topic_id,topic_type) values ('manager\\\'s view','manager_s_view','views')
INSERT INTO topics (topic_name,topic_id,topic_type) values ('architect\\\'s view','architect_s_view','views')
INSERT INTO topics (topic_name,topic_id,topic_type) values ('mission status','mission_status','cfengine_knowledge_base')
INSERT INTO topics (topic_name,topic_id,topic_type) values ('views','views','cfengine_knowledge_base')
...
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('workflows','actions','are formed by combining','combine into','promise_theory','promise_theory');
...
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('stories','topics','are formed by combining','can be combined into','promise_theory','promise_types');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('services','services','has subcategory','are instances of','promise_theory','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('services','services','has subcategory','are instances of','promise_theory','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('services','promises','are formed by combining','combine into','promise_theory','system_policy');
...
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('cascading','hierarchical structure','is the same as','is the same as','models_of_organization','models_of_organization');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('object paradigm','object paradigm','is the same as','is the same as','models_of_organization','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('aspect paradigm','aspect paradigm','is the same as','is the same as','models_of_organization','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('service orientation','peer to peer network','is the same as','is the same as','models_of_organization','models_of_organization');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('hierarchical structure','hierarchical structure','is the same as','is the same as','models_of_organization','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('audit','system reports','consists of','are an aspect of','BDMA','cfengine_knowledge_base');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('manage','manage','consists of','can be used as part of','BDMA','monitoring');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('manage','system outputs','consists of','can be used as part of','BDMA','monitoring');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('manage','monitoring','consists of','can be used as part of','BDMA','monitoring');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('deploy','packages','makes use of','can be used as part of','BDMA','promise_types');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('deploy','update','makes use of','can be used as part of','BDMA','promise_types');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('build','promises','consists of','are a key ingredient for','BDMA','system_policy');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('build','promises','consists of','are a key ingredient for','BDMA','system_policy');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('build','system policy','bare metal installation with','can be used as part of','BDMA','mission_status');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('build','PXE','bare metal installation with','can be used as part of','BDMA','mission_status');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('BDMA','BDMA','is inspired by','describes model','models_of_system_administration','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('self-healing','self-healing','enhances','is enhanced by','models_of_system_administration','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('autonomics','autonomics','enhances','is enhanced by','models_of_system_administration','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('computer immunology','computer immunology','enhances','is enhanced by','models_of_system_administration','(null)');
...
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('hosts','hosts','form the bulk of','are composed from','machine_resources','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('security view','software patches report','contains current state summary','is a resource for','views','system_reports');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('security view','setuid report','contains current state summary','is a resource for','views','system_reports');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('operation\\\'s view','system outputs','see policy-defined events in','are an aspect of','views','monitoring');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('operation\\\'s view','installed software report','displays operational state in','is a resource for','views','system_reports');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('operation\\\'s view','performance report','displays operational state in','is a resource for','views','system_reports');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('operation\\\'s view','performance report','displays operational state in','is a resource for','views','system_reports');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('operation\\\'s view','host portal','displays operational state in','is a resource for','views','system_reports');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('manager\\\'s view','BDMA','contains current state summary','is an aspect of','views','models_of_system_administration');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('manager\\\'s view','compliance report','contains current state summary','is an aspect of','views','models_of_system_administration');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('manager\\\'s view','compliance report','sees the catalogue of','are an aspect of','views','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('manager\\\'s view','compliance report','has sub-category','is a category in','views','(null)');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('architect\\\'s view','copernicus','has reference support in','is a resource for','views','cfengine_knowledge_base');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('architect\\\'s view','copernicus','is informed by','are an aspect of','views','system_policy');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('architect\\\'s view','contexts','is informed by','are an aspect of','views','system_policy');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('architect\\\'s view','contexts','is informed by','are an aspect of','views','system_policy');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('architect\\\'s view','system policy','planning the system lifecycle','is an aspect of','views','mission_status');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('architect\\\'s view','BDMA','planning the system lifecycle','is an aspect of','views','mission_status');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('mission status','security view','switch to','go back to','cfengine_knowledge_base','views');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('mission status','operation\'s view','switch to','go back to','cfengine_knowledge_base','views');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('mission status','manager\'s view','switch to','go back to','cfengine_knowledge_base','views');
INSERT INTO associations (from_name,to_name,from_assoc,to_assoc,from_type,to_type) values ('mission status','architect\'s view','switch to','go back to','cfengine_knowledge_base','views');
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('system_outputs','Messages sent by cfengine to the operators as a matter of policy.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('samba','The Unix service for integrating with MS Windows','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('NFS','Network File System (storage)','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('DHCP','An IP configuration service.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('NIS','Sun\'s Network Information Service (previously called Yellow Pages).','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('DB','Relational database services','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('LDAP','A well-known directory service. MS Active Directory purports to support this standard.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('DNS','Domain Name Service for translating Internet addresses into hostnames and vice versa.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('BOOTP','A simple broadcast protocol for booting a system directly from the network, e.g. for installation purposes.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('PXE','A composite network service based on the PXE protocol, allows systems to boot directly from the network.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('boot','Boot services are a way of booting a computer directly from the network','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('monitoring','Pseudo-real-time status information about system components','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('storage','Remotely accessible disk volumes.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('directory_services','Directory services are look-up services, typically with identity or host information.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('web','The WWW web service','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('configuration','Cfengine desired-state automation and self-repair service','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('mail','Electronic mail service, as made famous by the Unix operating system.','4','Explanation')
...
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('services','An abstraction for actions or processes that keep a specific set of promises. Services are black-boxes. Services generall fall into several classes: human services such as help-desk services, application services, network services, etc.','4','definitions')
...
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('audit','Traditionally servers needed to be audited to determine their actual state. Under cfengine, auditing simply means generating summary reports about recent compliance or repair operations.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('manage','Traditionally servers needed to be managed by responding to incidents. Under cfengine indicdents are repaired automatically and management is chiefly about observing and diving the success of the current system policy.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('deploy','Traditionally servers were deployed by pushing out a cloned image. Under cfengine the deployment of policy just means publishing a new version of policy on a policy server.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('build','Also called \"provisioning\" systems, i.e. the process of specifying and assembling the resources to fulfill a set of system promises. Traditionally servers were built as a \"golden image\" for cloning. Under cfengine, the build phase of the server lifecycle involves planning policy for the desired-state. Installation may also be considered a part of the build process.','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('BDMA','Build, Deploy, Manage and Audit. A model for the system life-cycle.','4','Explanation')
...
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('hosts','A general term for computers that run applications of any kind','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('available_patches','/reports/192.168.1.100/software_patches_avail.html','0','status 192.168.1.100')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('available_patches','Patches already installed on system','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('installed_patches','/reports/192.168.1.100/software_patch_status.html','0','status 192.168.1.100')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('installed_patches','For systems with a separate patch model, this shows OS software patches. There are two reports (for current status and patches that are available but not already applied)','4','description')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('installed_patches','Patches not yet installed, but published by vendor','4','Explanation')
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('host_portal','Portal to access mission status, monitored host data','4','Explanation')
...
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('mission_status','/reports/host_portal.html','0','host portal')
...
INSERT INTO occurrences (topic_name,locator,locator_type,subtype) values ('mission_status','/reports/meters.png','5','site summary')
